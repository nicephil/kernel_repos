...
#define AP152_WL8200IT2_DEV_NAME      "WL8200-IT2"
...
#define AP152_WA115AC_DEV_NAME         "WA115AC"
    ...
    } else if (!strcmp(ok_dev_name, AP152_WL8200T2_DEV_NAME) || !strcmp(ok_dev_name, AP152_WL8200IT2_DEV_NAME)) {
    ...
    } else if (!strcmp(ok_dev_name, AP152_OKA750_DEV_NAME) || !strcmp(ok_dev_name, AP152_OKA751_DEV_NAME)) {
